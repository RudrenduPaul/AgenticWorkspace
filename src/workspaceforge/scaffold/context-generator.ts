...
Generated by WorkspaceForge. This file is loaded at the start of every
...
${moduleLines.length > 0 ? moduleLines.join("\n") : "No modules detected yet. Re-run `workspaceforge init` after adding source directories."}

## Session handoff

Check \`.workspace/handoff/\` for the most recent session's notes before
starting new work. Run \`workspaceforge status --json\` for a machine-readable
